    ...
    + `C#` Написать две отдельные программы :
        ...
        + Создать 2 класса:
            ...
            + Второй должен уметь делать 3 вещи с объектами типа Point: 
                ...
                1. Уможать два объекта типа `Point` таким образом:  $X_{\text{новый}}=X_{1}*X_{2}$ $Y_{\text{новый}=}Y_{1}*Y_{2}$,
                1. Находить факториал от X и складывать его с $\pi^Y$ и возвращать новый объект типа Point($X_{\text{новый}},Y_{\text{новый}})$, такой что $X_{\text{новый}}=Factorial(X)$, $Y_{\text{новый}}=\pi^Y+Factorial(X)$.
    + `Git`
